...
public class MainActivity extends AppCompatActivity {
            ...
            try{
                for(String dir : assets.list("TBC"))
                {
                    ...
                    for(String file : assets.list("TBC/" + dir))
                    {
                        ...
                        //copy files from assets to the mobiles's sd card or any secondary memory available
                        copyFile(in,out);
                        in.close();
                        out.flush();
                        out.close();
    ...
    public static boolean isSDCartAvailable() {
        return Environment.getExternalStorageDirectory().equals(Environment.MEDIA_MOUNTED)?true:false;
    }
